---
slug: "/Basic_Charts/Stacked/Percent/3D_Bar_Chart"
sidebar_position: 11
---
...
To build a 3D Percent Stacked Bar Chart, create a multiple-series [3D Bar Chart](../../3D/Bar_Chart) and set the {api:anychart.scales.Linear#stackMode}stackMode(){api} method into **percent**:
