...
To build a Percent Stacked Step Area Chart, you should create a multiple-series [Step Area Chart](../../step-area-chart) and set {api:anychart.scales.Linear#stackMode}stackMode(){api} to **percent**:
