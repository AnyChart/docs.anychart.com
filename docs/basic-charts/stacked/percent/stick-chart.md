...
To build a Percent Stacked Stick Chart, create a multiple-series [Stick Chart](../../stick-chart) and set {api:anychart.scales.Linear#stackMode}stackMode(){api} to **percent**:
