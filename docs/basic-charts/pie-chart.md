...
<tr><td>Modules</td><td>[Core](../quick-start/modules#core) + [Pie and Doughnut](../quick-start/modules#pie-and-doughnut) / [Base](../quick-start/modules#base)</td></tr>
...
<tr><td>3D</td><td>[3D Pie](3d/pie-chart)</td></tr>
...
It is possible to configure the appearance of each chart point individually - use extra data fields corresponding to the methods mentioned in the [Slices](#slices) and [Outlines](#outlines) sections:
