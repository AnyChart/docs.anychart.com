---
slug: "/Basic_Charts/Venn_Diagram"
...
<tr><td>Modules</td><td><a href="../Quick_Start/Modules#core">Core</a> + <a href="../Quick_Start/Modules#venn-diagram">Venn Diagram</a></td></tr>
<tr><th colspan=2>API</th></tr>
<tr><th colspan=2>API</th></tr>
<tr><td>Class</td><td>{api:anychart.charts.Venn}anychart.charts.Venn{api}</td></tr>
<tr><th colspan=2>DATA</th></tr>
<tr><td>Data Fields</td><td><a href="../Working_with_Data/Overview">x, value, name</a></td></tr>
...
The Venn diagram requires adding the [Core](../Quick_Start/Modules#core) and [Venn Diagram](../Quick_Start/Modules#venn-diagram) modules:
