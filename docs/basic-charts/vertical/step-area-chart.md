...
To learn more about vertical charts in general and how to customize them, see [Vertical Charts (Overview)](overview).  You can also read the [Step Area Chart](../step-area-chart) article to learn about other available settings.
