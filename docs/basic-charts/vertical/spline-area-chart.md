...
To learn more about vertical charts in general and how to customize them, see [Vertical Charts (Overview)](overview).  You can also read the [Spline Area Chart](../spline-area-chart) article to learn about other available settings.
