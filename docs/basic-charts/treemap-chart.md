...
<tr><td>Modules</td><td>[Core](../quick-start/modules#core) + [Treemap](../quick-start/modules#treemap)</td></tr>
<tr><th colspan=2>API</th></tr>
<tr><td>Class</td><td>{api:anychart.charts.TreeMap}anychart.charts.TreeMap{api}</td></tr>
<tr><th colspan=2>DATA</th></tr>
<tr><td>Data Fields</td><td>[id, parent, children, name, size, value](../working-with-data/overview)</td></tr>
...
<tr><td></td><td>[Marimekko](marimekko-chart)</td></tr>
...
**Note 1:** It is possible to add custom fields to your data - see the [Labels and Tooltips](#labels-and-tooltips) section of this article.
...
Please note: you do not need to specify values and sizes of parent elements - they are calculated automatically. Also note that tiles are [sorted](#sorting-order) by value, but if you add the `size` field, they are sorted by size.
