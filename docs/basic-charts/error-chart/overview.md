...
This feature is often used with scatter charts, but Cartesian charts in AnyChart also support error bars - see the [Supported Types](#supported-types) section.
