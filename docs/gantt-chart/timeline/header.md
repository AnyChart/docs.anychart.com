...
To adjust [individual levels](#individual-levels), use the following methods:
...
The {api:anychart.core.gantt.TimeLineHeader}format(){api} method of the header allows you to format the text of [all levels](#all-levels).
