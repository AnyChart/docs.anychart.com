...
**Note:** To learn more about the types of editing, see the [Default Behavior](#default-behavior) section.
...
<tr><td>**Editing Data Structure**<br><a href="#rows">Rows</a></td><td>{api:anychart.core.gantt.edit.StructureEdit}anychart.core.gantt.edit.StructureEdit{api}</td><td>Chart<br>Data Grid<br>Timeline</td></tr>
<tr><td>**Editing Elements**<br><a href="#elements">Elements</a><br><a href="#controls">Controls</a></td><td>{api:anychart.core.gantt.edit.ElementEdit}anychart.core.gantt.edit.ElementEdit{api}</td><td>Element</td></tr>
</table>
