---
slug: "/Gantt_Chart/Data_Grid/Tooltips"
sidebar_position: 6
---
# Tooltips
...
In the sample below, a formatting function is used to display different tooltips for different types of [tasks](../Project_Chart#tasks-actual)). Also, in all tooltips the content of a custom data field `manager` is shown.
