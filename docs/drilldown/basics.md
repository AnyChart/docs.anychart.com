...
Basically the work is done, this foundation provides us with all we need and we will now [tune the chart](#tune-the-chart), add [a drill-up button](#drill-up-button), and show that [multilevel drilldown](#multilevel-drilldown) is also possible.
