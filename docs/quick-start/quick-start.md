...
You can use the link as shown below or download anychart.min.js from the [download page](Quick_Start/Downloading_AnyChart) and then put it into any folder of your site (you have to use your own link in this case). 
