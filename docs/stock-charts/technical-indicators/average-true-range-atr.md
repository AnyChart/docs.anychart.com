---
slug: "/Stock_Charts/Technical_Indicators/Average_True_Range_(ATR)"
---
# Average True Range
...
Mathematical description: [Average True Range (ATR) Mathematical Description](Mathematical_Description#average-true-range).
