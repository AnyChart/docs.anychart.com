...
Then, you need to provide fill or stroke settings in the data, be it [array of arrays](#data-as-array-of-arrays) or [array of objects](#data-as-array-of-objects):
