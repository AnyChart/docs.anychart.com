...
Spline Area series is very similar to [Area series](area). To know how to manage Spline Area and Area series in Basic Charts, see the [Area Chart article](../../basic-charts/area-chart).
...
See the [Chart Plots article](../chart-plots) to know how to manage plots.
