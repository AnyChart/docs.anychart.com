...
The [appearance settings](../../../appearance-settings) of a Triangle annotation can be configured in three [states](../../../common-settings/interactivity/states): **normal**, **hover**, and **selected**. Use the following methods:
