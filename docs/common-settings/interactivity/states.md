---
slug: "/Common_Settings/Interactivity/States"
---
# States
...
**Note 2:** There is also an alternative way to set the normal state of a chart: see the [Shortcuts](#shortcuts-normal)) section.
...
See the [Series](#series) section of this article to learn more. Some additional information can be found in the [Points](#series) and [Shortcuts](#shortcuts-normal)) sections.
