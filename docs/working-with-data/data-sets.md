...
Mapping is required if you set the data as an  [array of arrays](#array-of-arrays) or a [CSV string](#csv-string).
...
If your data is organized as an [array of objects](#array-of-objects), you should to link the field names required by the series to the names of fields in the data:
...
If your data is organized as an [array of objects](#array-of-objects) and contains custom fields, you need to remap it.
