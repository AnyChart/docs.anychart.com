---
slug: "/Working_with_Data/Overview"
...
It is recommended that you read [Quick Start](../Quick_Start) article before you read any article in this section.
...
- [JavaScript API](Supported_Data_Formats#javascript-api)
- [XML](Supported_Data_Formats#xml)
- [JSON](Supported_Data_Formats#json)
- [CSV](Supported_Data_Formats#csv)
- [Google Spreadsheet](Supported_Data_Formats#google-spreadsheet)
- [HTML Table](Supported_Data_Formats#html-table)
