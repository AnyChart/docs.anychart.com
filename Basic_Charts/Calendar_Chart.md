...
In the sample below, the container starts 200 pixels tall, and auto height grows it to fit the five years in the data:
...
chart.listen("chartDraw", function () {
  ...
  container.style.height = chart.getActualHeight() + "px";
});
```
