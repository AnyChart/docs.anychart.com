...
series1.normal().fill("#005e66", 0.5);
series1.hovered().fill("#005e66", 0.3);
series1.selected().fill("#005e66", 0.7);
series1.normal().stroke("#005e66", 1);
series1.hovered().stroke("#005e66", 2);
series1.selected().stroke("#005e66", 4);

// create the second series
var series2 = chart.mekko(seriesData_2);

// configure the visual settings of the second series
series2.normal().fill("#2a363c", 0.5);
series2.hovered().fill("#2a363c", 0.3);
series2.selected().fill("#2a363c", 0.7);
series2.normal().hatchFill("forward-diagonal", "#2a363c", 1, 15);
series2.hovered().hatchFill("forward-diagonal", "#2a363c", 1, 15);
series2.selected().hatchFill("forward-diagonal", "#2a363c", 1, 15);
series2.normal().stroke("#2a363c");
series2.hovered().stroke("#2a363c", 2);
series2.selected().stroke("#2a363c", 4);
```
