...
var rangeData1 = [
  ["Task 1", Date.UTC(2023,0,4), Date.UTC(2023,7,1)],
  ["Task 2", Date.UTC(2023,7,1), Date.UTC(2024,8,10)]
];

var rangeData2 = [
  ["New Task 1", Date.UTC(2024,10,1), Date.UTC(2025,5,1)],
  ["New Task 2", Date.UTC(2025,5,15), Date.UTC(2025,11,1)]
];

var momentData1 = [
  [Date.UTC(2023,2,21), "Meeting 1"],
  [Date.UTC(2024,3,19), "Meeting 2"],
  [Date.UTC(2025,1,1),  "Meeting 3"]
];

var momentData2 = [
  [Date.UTC(2023,5,12), "Training 1"],
  [Date.UTC(2024,5,1),  "Training 2"],
  [Date.UTC(2025,1,26), "Training 3"]
];
...
var rangeData1 = [
  {name: "Task 1", start: Date.UTC(2023,0,4), end: Date.UTC(2023,11,1)},
  {name: "Task 2", start: Date.UTC(2023,7,1), end: Date.UTC(2024,8,10)}
];

var rangeData2 = [
  {name: "New Task 1", start: Date.UTC(2024,10,1), end: Date.UTC(2025,5,1)},
  {name: "New Task 2", start: Date.UTC(2025,5,15), end: Date.UTC(2025,11,1)}
];

var momentData1 = [
  {x: Date.UTC(2023,2,21), y: "Meeting 1"},
  {x: Date.UTC(2024,3,19), y: "Meeting 2"},
  {x: Date.UTC(2025,1,1),  y: "Meeting 3"}
];

var momentData2 = [
  {x: Date.UTC(2023,5,12), y: "Training 1"},
  {x: Date.UTC(2024,5,1),  y: "Training 2"},
  {x: Date.UTC(2025,1,26), y: "Training 3"}
];
...
var rangeData1 = [
  {name: "Task 1", start: Date.UTC(2023,0,4), end: Date.UTC(2023,7,1),
...
textMarker1.value(Date.UTC(2023,0,1));
textMarker2.value(Date.UTC(2024,0,1));
...
lineMarker1.value(Date.UTC(2023,0,1));
lineMarker2.value(Date.UTC(2024,0,1));
...
rangeMarker1.from(Date.UTC(2023,0,1));
rangeMarker1.to(Date.UTC(2024,0,1));

// set the range of the second marker
rangeMarker2.from(Date.UTC(2024,0,1));
rangeMarker2.to(Date.UTC(2025,0,1));
...
chart.scale().minimum(Date.UTC(2022,7,30));
chart.scale().maximum(Date.UTC(2026,5,30));
...
chart.zoomTo(Date.UTC(2024,3,1), Date.UTC(2025,3,1)); 
```
