...
To build a 3D Stacked Area Chart, create a multi-series [3D Area Chart](../../3D/Area_Chart) and set the {api:anychart.scales.Linear#stackMode}stackMode(){api} method into <strong>value</strong>:
