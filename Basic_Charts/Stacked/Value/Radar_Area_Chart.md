...
To build a Radar Stacked Area Chart, create a multi-series [Radar Area Chart](../../Radar/Area_Chart) and set the {api:anychart.scales.Linear#stackMode}stackMode(){api} method into <strong>value</strong>:
