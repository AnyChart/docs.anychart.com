...
To build a 3D Percent Stacked Bar Chart, create a multi-series [3D Bar Chart](../../3D/Bar_Chart) and set the {api:anychart.scales.Linear#stackMode}stackMode(){api} method into <strong>percent</strong>:
