...
A Percent Stacked Area Chart (otherwise known as a 100% Stacked Area Chart) is a multi-series Area Chart that displays the trend of the percentage each value contributes over time or categories.
