...
In AnyChart you can sort the slices of a Pie chart in an ascending or descending order if you use the {api:anychart.charts.Pie#sort}sort(){api} method and <strong>"asc"</strong>, <strong>"desc"</strong>, or <strong>"none"</strong> as a parameter (there default sorting mode is "none"):
