...
Percent stacked mode calculates the proportion of each point to the category sum and uses this percentage as a value. To enable this mode set {api:anychart.enums.ScaleStackMode}stackMode("percent"){api}.
...
**Note:** full information on grid settings can be found in [Grid section of Axes tutorial](../../Axes_and_Grids/Axis_Basics#grids)
