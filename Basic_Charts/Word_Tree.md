...
The maximum and minimum font size cannot be set this way. Also, please note: individual settings are applied to all the children of the element you adjust, but a child's own individual settings override the parent settings:
