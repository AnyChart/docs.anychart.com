...
A Word Tree can have only one root word. It is always explicitly specified in [tree data](#tree). With [lists](#list) and [text](#texts), the {api:anychart.charts.Wordtree#word}word(){api} method is used:
