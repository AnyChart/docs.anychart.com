...
You can establish the hierarchy between words **explicitly**, by passing [tree](#tree) data to the chart constructor. Alternatively, the relationship between words can be established **implicitly**: when you pass a [list](#list) of phrases or a [text](#text), AnyChart engine automatically analyzes the data.
