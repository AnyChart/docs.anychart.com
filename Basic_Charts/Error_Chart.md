...
**Cartesian**: [Area](Area_Chart), [Bar](Bar_Chart), [Column](Column_Chart), [Line](Line_Chart), [Marker](Marker_Chart#single_series), Spline, [SplineArea](Spline_Area_Chart), [StepArea](Step_Area_Chart), [StepLine](Step_Line_Chart);
