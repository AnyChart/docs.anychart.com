...
If you use object notation to set the data, you can configure each marker individually - use extra data fields corresponding to the methods mentioned in the [Size](#size), [Type](#type), and [Appearance](#appearance) sections of this article.
