...
<head>
  ...
  <script src="https://cdn.anychart.com/releases/8.7.0/js/anychart-circular-gauge.min.js" type="text/javascript"></script>
</head>
```
...
<head>
  <script src="https://cdn.anychart.com/releases/8.7.0/js/anychart-core.min.js" type="text/javascript"></script>
  <script src="https://cdn.anychart.com/releases/8.7.0/js/anychart-linear-gauge.min.js" type="text/javascript"></script>
</head>
```
