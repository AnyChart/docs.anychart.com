...
This setting determines the way how quarters, semesters, and years are calculated. In the following sample, it affects the second and third levels of the [header](Header), which display quarters and years:
