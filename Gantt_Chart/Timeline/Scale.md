...
This setting determines the way how quarters, semesters, and years are calculated and thus affects the corresponding levels of the [header](Header). For example, here configuring the fiscal year affects the second and third levels of the header, which display quarters and years:
