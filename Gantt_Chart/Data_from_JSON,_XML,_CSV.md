...
AnyChart JSON schema varies from version to version. For example, JSON Schema for AnyChart version DVF-3668-tree-data is located at [https://cdn.anychart.com/schemas/DVF-3668-tree-data/json-schema.json](https://cdn.anychart.com/schemas/DVF-3668-tree-data/json-schema.json).
...
AnyChart XML schema varies from version to version. For example, XML Schema for AnyChart version DVF-3668-tree-data is located at [https://cdn.anychart.com/schemas/DVF-3668-tree-data/xml-schema.xsd](https://cdn.anychart.com/schemas/DVF-3668-tree-data/xml-schema.xsd)). 
