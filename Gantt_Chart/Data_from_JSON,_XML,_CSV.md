...
AnyChart JSON schema varies from version to version. For example, JSON Schema for AnyChart version RC-8.2.1 is located at [https://cdn.anychart.com/schemas/RC-8.2.1/json-schema.json](https://cdn.anychart.com/schemas/RC-8.2.1/json-schema.json).
...
AnyChart XML schema varies from version to version. For example, XML Schema for AnyChart version RC-8.2.1 is located at [https://cdn.anychart.com/schemas/RC-8.2.1/xml-schema.xsd](https://cdn.anychart.com/schemas/RC-8.2.1/xml-schema.xsd)). 
