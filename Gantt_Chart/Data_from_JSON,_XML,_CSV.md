...
AnyChart JSON schema varies from version to version. For example, JSON Schema for AnyChart version DVF-3692-table is located at [https://cdn.anychart.com/schemas/DVF-3692-table/json-schema.json](https://cdn.anychart.com/schemas/DVF-3692-table/json-schema.json).
...
var xml =
        '<anychart xmlns="https://cdn.anychart.com/schemas/DVF-3692-table/xml-schema.xsd">'+
...
AnyChart XML schema varies from version to version. For example, XML Schema for AnyChart version DVF-3692-table is located at [https://cdn.anychart.com/schemas/DVF-3692-table/xml-schema.xsd](https://cdn.anychart.com/schemas/DVF-3692-table/xml-schema.xsd)). 
