...
Link the locale from your server or [AnyChart CDN](https://cdn.anychart.com/) and pass the code of the locale to {api:anychart.format#inputLocale}inputLocale(){api}:
