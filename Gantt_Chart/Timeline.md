...
As you see, we can define some parameters of each linemarker such as color, dashes or thickness using {api:anychart.core.axisMarkers.Line#stroke}.stroke(){api} method. It is used absolutely the same way as any other line settings with the
