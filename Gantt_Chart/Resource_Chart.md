...
If there are [hierarchical relationships](#hierarchy) between data items, parent resources are visualized as empty rows on the timeline. See [Basic Settings: Expanding / Collapsing](Basic_Settings#expanding\_collapsing) to learn how to expand or collapse them.
