...
* `collapsed` to [expand or collapse](Basic_Settings#expanding\_/\_collapsing) a parent task
...
Also, see [Basic Settings: Expanding / Collapsing](Basic_Settings#expanding\_/\_collapsing) to learn how to expand or collapse parent tasks.
