...
<td>{sample :width 280 :height 150}GANTT\_Column\_Presets\_01{sample}</td>
</tr>
<tr>
...
<td>{sample :width 280 :height 150}GANTT\_Column\_Presets\_02{sample}</td>
</tr>
<tr>
...
<td>{sample :width 280 :height 150}GANTT\_Column\_Presets\_03{sample}</td>
</tr>
<tr>
<td><b>dateUsShort</b></td>
<td>Display date as yyyy-mm-dd. Day, month and year have numeric format. Year is 4 figures long while month and day are 2 figures long</td>
<td>{sample :width 280 :height 150}GANTT\_Column\_Presets\_04{sample}</td>
</tr>
<tr>
<td><b>percent</b></td>
<td>Format percentage values (assuming that for numeric values *1* stands for *100%* and for string values *"1"* stands for *1%*</td>
<td>{sample :width 280 :height 150}GANTT\_Column\_Presets\_05{sample}</td>
</tr>
<tr>
<td><b>directNumbering</b></td>
<td>Format simple numbers</td>
<td>{sample :width 280 :height 150}GANTT\_Column\_Presets\_06{sample}</td>
</tr>
<tr>
<td><b>shortText</b></td>
<td>adjusting text values and fitting it into small columns</td>
<td>{sample :width 280 :height 150}GANTT\_Column\_Presets\_07{sample}</td>
</tr>
<tr>
<td><b>text</b></td>
<td>Show simple text values without any adjustment</td>
<td style="padding-left: 5px;">{sample :width 280 :height 150}GANTT\_Column\_Presets\_08{sample}</td>
</tr>
</tbody>
</table>
