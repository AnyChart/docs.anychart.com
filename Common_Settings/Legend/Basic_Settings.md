...
The {api:anychart.core.ui.Legend#position}position(){api} and {api:anychart.core.ui.Legend#align}align(){api} methods allow positioning the legend relative to the chart and setting its alignment.
