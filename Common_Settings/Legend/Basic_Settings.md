...
You can position the legend relative to the chart by calling the {api:anychart.core.ui.Legend#position}position(){api} method. To align the legend, call {api:anychart.core.ui.Legend#align}align(){api}.
