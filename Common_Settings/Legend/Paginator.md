...
You can adjust the paginator by combining the **legend()** method of the chart and {api:anychart.core.ui.Legend#paginator}paginator(){api} with the following methods:
