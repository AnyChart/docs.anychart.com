...
To adjust scroll bar height (width) use the {api:anychart.core.ui.ChartScroller#height}height(){api} method. There are also  {api:anychart.core.ui.ChartScroller#maxHeight}maxHeight(){api} and {api:anychart.core.ui.ChartScroller#minHeight}minHeight(){api} methods which are useful when your charts are being resized.
