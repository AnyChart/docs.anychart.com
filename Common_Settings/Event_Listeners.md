...
To stop listen to the particular action, place an {api:anychart.core.Chart#unlisten}unlisten(){api} method to the event you would like to stop listen to inside the {api:anychart.core.Chart#listen}listen(){api} method, enabled for any action.
