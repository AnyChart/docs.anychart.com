...
table.addData([
    ['2025-12-25', 511.53, 514.98, 505.79, 506.40],
    ['2025-12-26', 512.53, 514.88, 505.69, 510.34],
    ['2025-12-27', 511.83, 514.98, 505.59, 507.23],
    ['2025-12-28', 511.22, 515.30, 505.49, 506.47],
    ['2025-12-29', 511.53, 514.98, 505.79, 506.40],
    ['2025-12-30', 512.53, 513.88, 505.69, 510.34],
    ['2025-12-31', 511.83, 512.98, 502.59, 503.23],
    ['2026-01-01', 511.22, 515.30, 505.49, 506.47],
    ['2026-01-02', 510.35, 515.72, 505.23, 508.80]
]);
```
...
table.addData([
    {'x': '2025-12-25', 'open': 511.53, 'high': 514.98, 'low': 505.79, 'close': 506.40},
    {'x': '2025-12-26', 'open': 512.53, 'high': 514.88, 'low': 505.69, 'close': 510.34},
    {'x': '2025-12-27', 'open': 511.83, 'high': 514.98, 'low': 505.59, 'close': 507.23},
    {'x': '2025-12-28', 'open': 511.22, 'high': 515.30, 'low': 505.49, 'close': 506.47},
    {'x': '2025-12-29', 'open': 511.53, 'high': 514.98, 'low': 505.79, 'close': 506.40},
    {'x': '2025-12-30', 'open': 512.53, 'high': 513.88, 'low': 505.69, 'close': 510.34},
    {'x': '2025-12-31', 'open': 511.83, 'high': 512.98, 'low': 502.59, 'close': 503.23},
    {'x': '2026-01-01', 'open': 511.22, 'high': 515.30, 'low': 505.49, 'close': 506.47},
    {'x': '2026-01-02', 'open': 510.35, 'high': 515.72, 'low': 505.23, 'close': 508.80}
]);
```
...
table.remove('2025-12-25', '2025-12-28');
```
...
```
// remove one row
table.remove('2025-12-26','2025-12-26');
```
...
table.addData([
    ['2025-12-25', 211, '#00FF00'],
    ['2025-12-26', 512],
    ['2025-12-27', 311],
    ['2025-12-28', 411],
    ['2025-12-29', 611, '#FF0000'],
    ['2025-12-30', 512],
    ['2025-12-31', 411],
    ['2026-01-01', 311],
    ['2026-01-02', 510]
...
var table = anychart.data.table('x');
table.addData([
    {x: '2025-12-25', volume: 211, stroke: '2px #00FF00'},
    {x: '2025-12-26', volume: 512},
    {x: '2025-12-27', volume: 311},
    {x: '2025-12-28', volume: 411},
    {x: '2025-12-29', volume: 611, stroke: '2px  #FF0000'},
    {x: '2025-12-30', volume: 512},
    {x: '2025-12-31', volume: 411},
    {x: '2026-01-01', volume: 311},
    {x: '2026-01-02', volume: 510}
]);
