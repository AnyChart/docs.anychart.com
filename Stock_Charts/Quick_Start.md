...
<head>
	...
	<script src="https://cdn.anychart.com/releases/RC-8.2.1/js/anystock.min.js" type="text/javascript"></script>
</head>
```
...
<head>
    <meta charset="UTF-8"/>
    <script src="https://cdn.anychart.com/releases/RC-8.2.1/js/anychart-core.min.js" type="text/javascript"></script>
    <script src="https://cdn.anychart.com/releases/RC-8.2.1/js/anychart-stock.min.js" type="text/javascript"></script>
    <script>
	var table, mapping, chart;
	anychart.onDocumentReady(function () {
