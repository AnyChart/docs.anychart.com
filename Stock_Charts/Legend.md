...
**Note:** There might be multiple Stock charts in your data visualization. However, if you want to show their series in one legend, you still have to specify the plots as the source of items, not the charts.
