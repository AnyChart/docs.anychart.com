...
AnyChart js charting framework allows you to apply different visualization settings to a single point. It means that you can customize the point view explicitly from the data set. Let's consider how it works on a sample of JavaScript [Bar Chart](../Basic_Charts_Types/Bar_Chart).
...
Visual appearance of bars is defined using [these settings](../Basic_Charts_Types/Bar_Chart#visualization):
