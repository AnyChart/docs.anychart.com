...
```
<head>
    <script src="https://cdn.anychart.com/releases/8.6.0/js/graphics.min.js" type="text/javascript"></script>
</head>
```
...
<head>
    <meta charset="UTF-8"/>
    <script src="https://cdn.anychart.com/releases/8.6.0/js/graphics.min.js"></script>
</head>
<body>
    <div id="container" style="width: 100%; height: 100%"></div>
    <script>
