...
The [appearance settings](../../../appearance-settings) of a Marker annotation can be configured in three [states](../../../common-settings/interactivity/states): **normal**, **hover**, and **selected**. Use the following methods:
