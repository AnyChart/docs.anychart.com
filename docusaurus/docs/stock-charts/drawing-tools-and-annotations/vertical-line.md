...
The Vertical Line annotation allows you to add a vertical line to a chart.
...
The [appearance settings](../../../appearance-settings) of a Vertical Line annotation can be configured in three [states](../../../common-settings/interactivity/states): **normal**, **hover**, and **selected**. Use the following methods:
