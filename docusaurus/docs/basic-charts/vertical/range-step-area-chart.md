...
To learn more about vertical charts in general and how to customize them, see [Vertical Charts (Overview)](overview). You can also read the [Range Step Area Chart](../range-step-area-chart) article to learn about other available settings.
