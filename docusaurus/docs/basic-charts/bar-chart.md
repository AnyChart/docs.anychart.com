...
<tr><td>Stacked</td><td>[Stacked Bar](stacked/value/bar-chart), [Percent Stacked Bar](stacked/percent/bar-chart)</td></tr>
<tr><td>Vertical</td><td>[Bar](bar-chart)</td></tr>
<tr><td>3D</td><td>[3D Bar](3d/bar-chart)</td></tr>
<tr><td>Error Bars</td><td>[Bar Chart with Error Bars](error-chart/bar-chart)</td></tr>
