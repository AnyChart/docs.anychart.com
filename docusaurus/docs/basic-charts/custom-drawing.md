 ...
 * [Shapes Manager](#shapes-manager)
 * [States](#states)
 * [Prepare and Finalize](#prepare-and-finalize)
* [Samples](#samples)
 * [Rounded Columns](#rounded-columns)
 * [Cone Chart](#cone-chart)
 * [Cherry Chart](#cherry-chart)
...
This method is enough to handle most of custom drawing situations, you can see that only this method is used in [Rounded Columns](#rounded-columns) and [Cone Chart](#cone-chart) samples.
