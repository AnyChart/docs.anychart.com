...
To build a Vertical Percent Stacked Area Chart, you should create a multiple-series [Vertical Area Chart](../../vertical/area-chart) and set {api:anychart.scales.Linear#stackMode}stackMode(){api} to **percent**:
...
The Vertical Percent Stacked Area series' settings are mostly the same as other series'. The majority of information about adjusting series in AnyChart is given in the [General Settings article](../../general-settings).