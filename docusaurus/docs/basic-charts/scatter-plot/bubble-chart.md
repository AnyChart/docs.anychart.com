...
To learn more about scatter charts in general and how to customize them, see [Scatter Charts (Overview)](overview). In addition, you can read the [Bubble Chart](../bubble-chart) article to learn about other available settings.
