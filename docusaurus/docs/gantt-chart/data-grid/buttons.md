...
This article explains how to configure the [basic settings](#basic-settings) of buttons: content, font, background, etc. The [advanced settings](#advanced-settings) include background images and custom drawing.
