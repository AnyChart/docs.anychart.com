...
To remove an element from the default context menu you need to delete an item in the {api:anychart.ui.ContextMenu#itemsFormatter}itemsFormatter(){api} as show below. Menu item keys are listed in [Menu items keys](#menu-items-keys) section.
