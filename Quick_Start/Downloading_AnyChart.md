...
Download the latest installation package at [https://cdn.anychart.com/releases/8.12.0/anychart-installation-package-{{branch-name}}.zip](https://cdn.anychart.com/releases/8.12.0/anychart-installation-package-{{branch-name}}.zip)
