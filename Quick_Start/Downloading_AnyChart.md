...
Download the latest installation package at [https://cdn.anychart.com/releases/8.7.0/anychart-installation-package-{{branch-name}}.zip](https://cdn.anychart.com/releases/8.7.0/anychart-installation-package-{{branch-name}}.zip)
...
<link rel="stylesheet" href="https://cdn.anychart.com/releases/8.7.0/css/anychart-ui.min.css" />
```
