...
```
<script src="https://cdn.anychart.com/releases/8.9.0/js/anychart-gantt.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.9.0/js/anychart-linear-gauge.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.9.0/js/anychart-pert.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.9.0/js/anychart-resource.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.9.0/js/anychart-treemap.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.9.0/js/anychart-ui-binding.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.9.0/js/anychart-vml.min.js"></script>
```
