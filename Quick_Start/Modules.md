...
<head>
  <script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-core.min.js"></script>
  <script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-pie.min.js"></script>
  <script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-exports.min.js"></script>
</head>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-bullet.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-cartesian-3d.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-calendar.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-circle-packing.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-circular-gauge.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-gantt.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-map.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-graph.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-mekko.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-pareto.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-pert.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-polar.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-pyramid-funnel.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-radar.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-resource.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-sankey.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-scatter.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-sparkline.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-stock.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-sunburst.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-surface.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-tag-cloud.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-timeline.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-treemap.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-venn.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-waterfall.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-annotations.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-table.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-ui.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-ui-binding.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-vml.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.14.1/js/anychart-editor.min.js"></script>
```
