...
```
<script src="https://cdn.anychart.com/releases/8.7.1/js/anychart-bullet.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.7.1/js/anychart-circular-gauge.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.7.1/js/anychart-linear-gauge.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.7.1/js/anychart-pert.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.7.1/js/anychart-resource.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.7.1/js/anychart-sparkline.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.7.1/js/anychart-surface.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.7.1/js/anychart-waterfall.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.7.1/js/anychart-table.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.7.1/js/anychart-ui-binding.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.7.1/js/anychart-vml.min.js"></script>
```
