...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-bullet.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-cartesian-3d.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-circular-gauge.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-heatmap.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-map.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-mekko.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-pareto.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-pert.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-pyramid-funnel.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-radar.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-resource.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-scatter.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-sparkline.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-stock.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-tag-cloud.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-venn.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-waterfall.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-annotations.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-ui-binding.min.js"></script>
```
...
```
<script src="https://cdn.anychart.com/releases/8.6.0/js/anychart-vml.min.js"></script>
```
