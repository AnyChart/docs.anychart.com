...
As mentioned in [Quick Start](./Quick_Start) page, AnyChart can be used in any page. In this section we will take a closer look at all aspects of using chart on sites, controlled with WordPress Content Management System.
