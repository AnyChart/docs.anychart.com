...
<head>
    ...
    <script src="https://cdn.anychart.com/releases/8.7.0/js/anychart-map.min.js" type="text/javascript"></script>
</head>
```
...
```
<script src="https://cdn.anychart.com/geodata/2.0.0/countries/united_states_of_america/united_states_of_america.js"></script>
```
...
```
anychart.data.loadJsonFile("https://cdn.anychart.com/geodata/2.0.0/usa_states/texas/texas.json", function (data){
...
// set the data for the USA map
var usaDataSet = [
    {"id": "US.TX", "value": 26956958, "url": "https://cdn.anychart.com/geodata/2.0.0/usa_states/texas/texas.json"},
    {"id": "US.FL", "value": 19552860, "url": "https://cdn.anychart.com/geodata/2.0.0/usa_states/florida/florida.json"}
];
