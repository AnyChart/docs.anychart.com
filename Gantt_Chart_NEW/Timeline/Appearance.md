...
To learn how to configure the appearance of the data grid and timeline header, see the [Data Grid: Appearance](../Data_Grid/Appearance) and [Header: Appearance](Header#appearance) sections.
