...
(?) You can also add custom fields to your data and use them to configure [data grid tooltips](Data_Grid/Tooltips), [data grid labels](Data_Grid/Columns#text_\(labels\)), [timeline tooltips](Timeline/Tooltips), and [labels of elements](Elements#labels).
