...
The Resource Gantt chart, defined as an instance of {api:anychart.charts.Gantt}anychart.charts.Gantt{api} class, is used to show resources (e.g., equipment or employees) over periods of time. You can also show the hierarchical relationships between resources.
