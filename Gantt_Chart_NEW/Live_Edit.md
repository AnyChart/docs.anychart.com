...
Call the {api:?entry=edit}edit(){api} method of the chart, [data grid](Data_Grid), [timeline](Timeline), or [elements](Elements) to access the settings of either data structure editing or of element editing:
