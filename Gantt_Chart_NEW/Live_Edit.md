...
<tr><td>[Rows](#rows)</td><td>Chart<br>Data Grid<br>Timeline</td><td>{api:anychart.core.gantt.edit.StructureEdit}anychart.core.gantt.edit.StructureEdit{api}<br>(Editing Data Structure)</td></tr>
<tr><td>[Elements](#elements)<br>[Controls](#controls)</td><td>Elements</td><td>{api:anychart.core.gantt.edit.ElementEdit}anychart.core.gantt.edit.ElementEdit{api}<br>(Editing Elements)</td></tr>
</table>
