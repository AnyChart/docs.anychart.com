...
Call the {api:?entry=edit}edit(){api} method of the chart, [data grid](Data_Grid), [timeline](Timeline), or [elements](Elements) to access the settings either of data structure editing or of element editing:
...
<tr><td>Elements</td><td>**Editing Elements**<br>[Elements](#elements)<br>[Controls](#controls)</td><td>{api:anychart.core.gantt.edit.ElementEdit}anychart.core.gantt.edit.ElementEdit{api}</td></tr>
</table>
