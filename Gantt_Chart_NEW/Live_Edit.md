...
Drag and drop [timeline elements](Elements) to change their position on the timeline. To change the duration and progress of an element, use duration thumbs on its sides and the slider on the progress bar.
