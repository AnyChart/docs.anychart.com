...
* {api:anychart.core.gantt.elements.TasksElement#normal}normal(){api} and {api:anychart.core.gantt.elements.TasksElement#selected}selected(){api} to access the normal and selected [states](../Common_Settings/Interactivity/States)
* {api:anychart.core.gantt.elements.TasksElement#labels}labels(){api} to access t[labels](#labels)
