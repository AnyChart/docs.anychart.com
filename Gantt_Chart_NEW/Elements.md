...
Also, regular tasks have {api:anychart.core.gantt.elements.TasksElement#labels}labels(){api} to access [labels](#labels) and {api:anychart.core.gantt.elements.TasksElement#progress}progress(){api} to access [progress bars](#progress_bars).
