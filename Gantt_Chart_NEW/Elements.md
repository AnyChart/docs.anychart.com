...
**To access** labels of a particular element type, call its **labels()** method. Alternatively, you can access labels of [all elements](#all_elements) at once: call {api:anychart.core.ui.Timeline#elements}elements(){api}.
