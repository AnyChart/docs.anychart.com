...
* all elements of one type (types are listed in the [Project Chart](#project_chart) and [Resource Chart](#resource_chart) sections)
...
To access them, the following methods are used:
