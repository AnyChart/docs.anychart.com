...
The sections below explain how to configure default columns or create [custom columns](#custom_columns). Also, you can use column presets – see the [Column Presets](Сolumn_Presets) article.
