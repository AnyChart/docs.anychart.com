...
If you want to configure data labels and tooltips for all series - you should use{api:anychart.charts.Scatters#labels}.labels(){api} and {api:anychart.charts.Scatter#tooltip}.tooltip(){api} methods. You can tune the visual appearance, positioning and format of labels and tooltips.
