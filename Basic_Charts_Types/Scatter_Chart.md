...
If you want to configure data labels and tooltips for all series - you should use{api:anychart.charts.Scatter#label}.label(){api} and {api:anychart.charts.Scatter#tooltip}.tooltip(){api} methods. You can tune the visual appearance, positioning and format of labels and tooltips.
